...
<body>
<h1 align = center> Tableau de suivi de la production électrique: </h1>
<?php 
...
?>
<tr>
<td align = center style='color:9FE855';><?php echo $donnees['production_totale'] ?></td> 
...
<br><br><input type="submit" value="Mettre à jour" />
</p>
<div class="foot"><a href="<?php echo $url_home; ?>">Retour àl'accueil</a> </div>
</body>
</html>
